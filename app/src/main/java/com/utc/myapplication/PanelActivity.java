...
import com.utc.myapplication.util.Config;
    ...
    private void inicializarControles() {
        ...
        imgUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Config.Mensaje(PanelActivity.this, "Boton Arriba"+ UP, true,false);
            }
        });
        ...
        imgConnect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               /* new AlertDialog.Builder(PanelActivity.this)
                        ...
                        .show();*/
                Intent i = new Intent(PanelActivity.this, DeviceListActivity.class);
                startActivity(i);
            }
        });
